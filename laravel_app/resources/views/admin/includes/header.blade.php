    ...
    <header class="kt-header fixed top-0 z-10 start-0 end-0 flex items-stretch shrink-0 bg-background" data-kt-sticky="true" data-kt-sticky-class="border-b border-border" data-kt-sticky-name="header" id="header">
        ...
        <div class="kt-container-fixed flex justify-between items-stretch lg:gap-4" id="headerContainer">
            ...
            <div class="flex gap-2.5 lg:hidden items-center -ms-1">
                <a class="shrink-0" href="index.html">
                    <img class="max-h-[25px] w-full" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/app/mini-logo.svg"/>
                </a>
                    ...
                    <div class="hidden lg:flex lg:items-stretch [--kt-drawer-enable:true] lg:[--kt-drawer-enable:false]" data-kt-drawer="true" data-kt-drawer-class="kt-drawer kt-drawer-start fixed z-10 top-0 bottom-0 w-full me-5 max-w-[250px] p-5 lg:p-0 overflow-auto" id="mega_menu_wrapper">
                        ...
                        <div class="kt-menu flex-col lg:flex-row gap-5 lg:gap-7.5" data-kt-menu="true" id="mega_menu">
                            ...
                            <div class="kt-menu-item active">
                                <a class="kt-menu-link text-nowrap text-sm text-foreground font-medium kt-menu-item-hover:text-primary kt-menu-item-active:text-mono kt-menu-item-active:font-medium" href="index.html">
              ...
              <i class="ki-filled ki-minus text-xs">
                                                ...
                                                <div class="grid lg:grid-cols-2 lg:gap-5">
                                                    <div class="flex flex-col gap-0.5">
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/profiles/default.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Default
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/profiles/creator.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Creator
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/profiles/company.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Company
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/profiles/nft.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    NFT
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/profiles/blogger.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Blogger
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/profiles/crm.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    CRM
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/profiles/gamer.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Gamer
                                                    ...
                                                    <div>
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/profiles/feeds.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Feeds
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/profiles/plain.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Plain
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/profiles/modal.html" tabindex="0">
                   <span class="kt-menu-icon">
                     ...
                     Soon
                                            ...
                                            <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                ...
                                                <div class="grid lg:grid-cols-2 lg:gap-5">
                                                    <div class="flex flex-col gap-0.5">
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/projects/3-columns.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Projects - 3 Columns
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/projects/2-columns.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Projects - 2 Columns
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/works.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Works
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/teams.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Teams
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/network.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Network
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/activity.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Activity
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/campaigns/card.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Campaigns - Card
                                                    ...
                                                    <div>
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/campaigns/list.html" tabindex="0">
                   <span class="kt-menu-icon">
                    ...
                    Campaigns - List
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="public-profile/empty.html" tabindex="0">
                   <span class="kt-menu-icon">
              ...
              <i class="ki-filled ki-minus text-xs">
                                ...
                                <div class="kt-menu-dropdown flex-col lg:flex-row gap-0 w-full lg:max-w-[1240px]">
                                    <div class="lg:w-[250px] mt-2 lg:mt-0 lg:border-e lg:border-e-border rounded-xl lg:rounded-l-xl lg:rounded-r-none shrink-0 px-3 py-4 lg:p-7.5 bg-muted/25">
                                        ...
                                        <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="account/integrations.html">
                <span class="kt-menu-icon">
                 ...
                 Integrations
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="account/notifications.html">
                <span class="kt-menu-icon">
                 ...
                 Notifications
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="account/api-keys.html">
                <span class="kt-menu-icon">
                 ...
                 API Keys
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="account/appearance.html">
                <span class="kt-menu-icon">
                 ...
                 Appearance
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="account/invite-a-friend.html">
                <span class="kt-menu-icon">
                 ...
                 Invite a Friend
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="account/activity.html">
                <span class="kt-menu-icon">
                                    ...
                                    <div class="pt-4 pb-2 lg:p-7.5 lg:pb-5 grow">
                                        <div class="grid lg:grid-cols-5 gap-5">
                                            <div class="flex flex-col">
                                                ...
                                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/home/get-started.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Get Started
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/home/user-profile.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   User Profile
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/home/company-profile.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Company Profile
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/home/settings-sidebar.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   With Sidebar
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/home/settings-enterprise.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Enterprise
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/home/settings-plain.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Plain
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/home/settings-modal.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Modal
                  </span>
                                                        </a>
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/billing/basic.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Basic Billing
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/billing/enterprise.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Enterprise
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/billing/plans.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Plans
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/billing/history.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Billing History
                  </span>
                                                        </a>
                   ...
                   <span class="kt-badge kt-badge-sm">
                    Soon
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/security/get-started.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Get Started
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/security/overview.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Security Overview
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/security/allowed-ip-addresses.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   IP Addresses
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/security/privacy-settings.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Privacy Settings
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/security/device-management.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Device Management
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/security/backup-and-recovery.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Backup &amp; Recovery
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/security/current-sessions.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Current Sessions
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/security/security-log.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Security Log
                  </span>
                                                        </a>
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/members/team-starter.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Teams Starter
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/members/teams.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Teams
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/members/team-info.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Team Info
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/members/members-starter.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Members Starter
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/members/team-members.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Team Members
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/members/team-members-datatable.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Team Members (DataTables)
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/members/import-members.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Import Members
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/members/roles.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Roles
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/members/permissions-toggle.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Persmissions - Toggler
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/members/permissions-check.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Persmissions - Check
                  </span>
                                                        </a>
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/integrations.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Integrations
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/notifications.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Notifications
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/api-keys.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   API Keys
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/appearance.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Appearance
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/invite-a-friend.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Invite a Friend
                  </span>
                                                        </a>
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="account/activity.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
                   Activity
                  </span>
                                                        </a>
              ...
              <i class="ki-filled ki-minus text-xs">
                 ...
                 <span class="kt-menu-icon">
                                        ...
                                        <div class="pt-4 pb-2 lg:p-7.5 lg:pb-5 grow">
                                            <div class="grid lg:grid-cols-2 gap-5">
                                                <div class="flex flex-col gap-5">
                                                    ...
                                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="network/user-cards/mini-cards.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Mini Cards
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="network/user-cards/team-crew.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Team Crew
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="network/user-cards/nft.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Authors
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="network/user-cards/social.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    NFT Users
                   </span>
                                                            </a>
                  ...
                  Datatables
                                                    ...
                                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="network/user-table/team-crew.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Team Crew
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="network/user-table/app-roster.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    App Roster
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="network/user-table/market-authors.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Market Authors
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="network/user-table/saas-users.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    SaaS Users
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="network/user-table/store-clients.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Store Clients
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="network/user-table/visitors.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Visitors
                   </span>
                                                            </a>
                                    ...
                                    <div class="pt-4 pb-2 lg:p-7.5">
                                        <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                            ...
                                            <div class="grid lg:grid-cols-2 lg:gap-5">
                                                <div class="flex flex-col gap-0.5">
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/home.html" tabindex="0">
                  <span class="kt-menu-icon">
                   ...
                   Home
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/search-results-grid.html" tabindex="0">
                  <span class="kt-menu-icon">
                   ...
                   Search Results - Grid
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/search-results-list.html" tabindex="0">
                  <span class="kt-menu-icon">
                   ...
                   Search Results - List
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/product-details.html" tabindex="0">
                  <span class="kt-menu-icon">
                   ...
                   Product Details
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/shopping-cart.html" tabindex="0">
                  <span class="kt-menu-icon">
                   ...
                   Shopping Cart
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/wishlist.html" tabindex="0">
                  <span class="kt-menu-icon">
                   <i class="ki-filled ki-heart">
                   </i>
                  </span>
                   ...
                   Wishlist
                                                ...
                                                <div>
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/checkout/order-summary.html" tabindex="0">
                  <span class="kt-menu-icon">
                   ...
                   Checkout - Order Summary
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/checkout/shipping-info.html" tabindex="0">
                  <span class="kt-menu-icon">
                   ...
                   Checkout - Shipping Info
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/checkout/payment-method.html" tabindex="0">
                  <span class="kt-menu-icon">
                   ...
                   Checkout - Payment Method
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/checkout/order-placed.html" tabindex="0">
                  <span class="kt-menu-icon">
                   ...
                   Checkout - Order Placed
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/my-orders.html" tabindex="0">
                  <span class="kt-menu-icon">
                   ...
                   My Orders
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link" href="store-client/order-receipt.html" tabindex="0">
                  <span class="kt-menu-icon">
                   <i class="ki-filled ki-document">
                   </i>
                  </span>
              ...
              <i class="ki-filled ki-minus text-xs">
                                        ...
                                        <div class="pt-4 pb-2 lg:p-7.5 lg:pb-5 grow">
                                            <div class="grid lg:grid-cols-2 gap-5">
                                                <div class="flex flex-col">
                                                    ...
                                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/classic/sign-in.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Sign In
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/classic/sign-up.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Sign Up
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/classic/2fa.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    2FA
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/classic/check-email.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Check Email
                   </span>
                                                            </a>
                  ...
                  <span class="text-secondary-foreground font-medium text-sm p-2.5">
                   Reset Password
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/classic/reset-password/enter-email.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Enter Email
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/classic/reset-password/check-email.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Check Email
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/classic/reset-password/change-password.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Change Password
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/classic/reset-password/password-changed.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Password is Changed
                   </span>
                                                            </a>
                                                ...
                                                <div class="flex flex-col">
                                                    ...
                                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/branded/sign-in.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Sign In
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/branded/sign-up.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Sign Up
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/branded/2fa.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    2FA
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/branded/check-email.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Check Email
                   </span>
                                                            </a>
                  ...
                  <span class="text-secondary-foreground font-medium text-sm p-2.5">
                   Reset Password
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/branded/reset-password/enter-email.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Enter Email
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/branded/reset-password/check-email.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Check Email
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/branded/reset-password/change-password.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Change Password
                   </span>
                                                            </a>
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="authentication/branded/reset-password/password-changed.html" tabindex="0">
                   <span class="kt-menu-title grow-0">
                    Password is Changed
                   </span>
                                                            </a>
                                        ...
                                        <div class="lg:w-[260px] mb-4 lg:mb-0 lg:border-s lg:border-s-border rounded-xl lg:rounded-e-xl lg:rounded-l-none shrink-0 px-3 py-4 lg:p-7.5 bg-muted/25">
                                            ...
                                            <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                <div class="kt-menu-item">
                                                    <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="authentication/welcome-message.html">
                 <span class="kt-menu-icon">
                  ...
                  Welcome Message
                                                ...
                                                <div class="kt-menu-item">
                                                    <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="authentication/welcome-message-2.html">
                 <span class="kt-menu-icon">
                  <i class="ki-filled ki-element-11">
                  </i>
                 </span>
                  ...
                  Welcome Message 2
                                                ...
                                                <div class="kt-menu-item">
                                                    <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="authentication/account-deactivated.html">
                 <span class="kt-menu-icon">
                  ...
                  Account Deactivated
                                                ...
                                                <div class="kt-menu-item">
                                                    <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="authentication/error-404.html">
                 <span class="kt-menu-icon">
                  ...
                  Error 404
                                                ...
                                                <div class="kt-menu-item">
                                                    <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="authentication/error-500.html">
                 <span class="kt-menu-icon">
            ...
            <div class="flex items-center gap-2.5">
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-4.png')}}"/>
                                        </div>
               ...
               Web Design 2024
                ...
                For an expert opinion, check out what Mike has to say on this topic!
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-5.png')}}"/>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                            </div>
              ...
              <span class="kt-badge kt-badge-sm kt-badge-info kt-badge-outline">
               ...
               Redesign
                                ...
                                <div class="flex grow gap-2.5 px-5" id="notification_request_3">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-27.png')}}"/>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                            </div>
               ...
               Dev Team
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-10.png')}}"/>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
               ...
               742kb
                                        ...
                                        <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
                                            <img class="h-5" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/file-types/pdf.svg"/>
               ...
               Edited 39 mins ago
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-11.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              ...
              Roadmap
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-14.png')}}"/>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-offline size-2.5">
                                            </div>
               ...
               Metronic Launcher mockups
                                        ...
                                        <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
                                            <div class="flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-background rounded-sm border border-border">
                                                <img class="h-5" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/file-types/figma.svg"/>
                                            </div>
                                            <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1" href="#">
                                                Launcher-UIkit.fig
                                            </a>
                        ...
                        <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
                            <div class="flex flex-col gap-5 pt-3 pb-4">
                                <div class="flex grow gap-2.5 px-5" id="notification_request_13">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-25.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
             ...
             <span class="text-sm font-medium text-secondary-foreground">
              ...
              2 days ago
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-34.png')}}"/>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                            </div>
               ...
               ACME
                                        ...
                                        <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
                                            <div class="flex items-center gap-1.5">
                                                <img class="h-6" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/file-types/xls.svg"/>
                                                <div class="flex flex-col gap-0.5">
                 ...
                 2.6 MB
                                ...
                                <div class="flex grow gap-2 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-29.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                ...
                <span class="font-medium text-mono text-xs">
                 ...
                 Due Date: 15 May, 2024
                                                ...
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('admin/assets/media/avatars/300-3.png')}}"/>
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('admin/assets/media/avatars/300-2.png')}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="flex items-center gap-2.5">
               <span class="kt-badge kt-badge-sm kt-badge-success kt-badge-outline">
                ...
                Bug
                                ...
                                <div class="flex grow gap-2.5 px-5" id="notification_request_3">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-30.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
               ...
               Marketing
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-24.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              ...
              Dev Team
                        ...
                        <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
                            <div class="flex flex-col gap-5 pt-3 pb-4">
                                <div class="flex grow gap-2 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-15.png')}}"/>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                            </div>
               ...
               Dev Team
                  ...
                  9:00 PM - 10:00 PM
                                                ...
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('admin/assets/media/avatars/300-4.png')}}"/>
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('admin/assets/media/avatars/300-1.png')}}"/>
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('admin/assets/media/avatars/300-2.png')}}"/>
                                                    </div>
                 ...
                 <span class="hover:z-5 relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-6 text-white size-6 ring-background bg-green-500">
                  +3
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-6.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              ...
              Marketing
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-12.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
               ...
               Web Design
                                        ...
                                        <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
                                            <div class="flex items-center gap-1.5">
                                                <img class="h-6" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/file-types/word.svg"/>
                                                <div class="flex flex-col gap-0.5">
                                                    <a class="hover:text-primary font-medium text-secondary-foreground text-xs" href="#">
                                                        Landing-page.docx
                                                    </a>
                 ...
                 1.9 MB
                                        ...
                                        <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
                                            <div class="flex items-center gap-1.5">
                                                <img class="h-6" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/file-types/svg.svg"/>
                                                <div class="flex flex-col gap-0.5">
                                                    <a class="hover:text-primary font-medium text-secondary-foreground text-xs" href="#">
                                                        New-icon.svg
                                                    </a>
                 ...
                 2.3 MB
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-21.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
		...
		design is simply stunning! From layout to color, it's a work of art!
                                ...
                                <div class="flex grow gap-2.5 px-5" id="notification_request_3">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-13.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
		...
		Team
                        ...
                        <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
                            <div class="flex flex-col gap-5 pt-3 pb-4">
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-1.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
               ...
               Craftwork Design
                                        ...
                                        <div class="flex items-center gap-2.5">
                                            <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
                                                <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24" style="background-image: url('../dist/assets/media/images/600x600/6.jpg')">
                                                </div>
                  ...
                  81023
                                            ...
                                            <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
                                                <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24" style="background-image: url('../dist/assets/media/images/600x600/1.jpg')">
                                                </div>
                                                <div class="px-2.5 pb-2">
                                                    <a class="font-medium block text-secondary-foreground hover:text-primary text-xs leading-4 mb-0.5" href="#">
                  ...
                  67890
                                ...
                                <div class="flex grow gap-2.5 px-5" id="notification_request_17">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-19.png')}}"/>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                            </div>
               ...
               Designer
                                        ...
                                        <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
                                            <div class="flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-white rounded-sm border border-border">
                                                <img class="h-5" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/jira.svg"/>
                                            </div>
                                            <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1" href="#">
                                                User-feedback.jira
                                            </a>
               ...
               Edited 1 hour ago
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-17.png')}}"/>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                            </div>
		...
		article
              ...
              Nexus
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    <div class="kt-avatar size-8">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-9.png')}}"/>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                            </div>
		...
		Team
                            ...
                            <div class="flex items-center justify-between flex-wrap gap-2 px-5">
                                <div class="flex items-center flex-wrap gap-2">
                                    <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-11">
                                        <img alt="" class="size-7" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/gitlab.svg"/>
                                    </div>
                                    <div class="flex flex-col">
              ...
              Jessy is typing..
                                ...
                                <div class="flex items-center gap-2.5">
                                    <div class="flex -space-x-2">
                                        <div class="flex">
                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{asset('admin/assets/media/avatars/300-4.png')}}"/>
                                        </div>
                                        <div class="flex">
                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{asset('admin/assets/media/avatars/300-1.png')}}"/>
                                        </div>
                                        <div class="flex">
                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{asset('admin/assets/media/avatars/300-2.png')}}"/>
                                        </div>
                                        <div class="flex">
               ...
               +10
                                    ...
                                    <div class="kt-menu" data-kt-menu="true">
                                        <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
                                            ...
                                            <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                <div class="kt-menu-item">
                                                    <a class="kt-menu-link" href="account/members/teams.html">
                 <span class="kt-menu-icon">
                  <i class="ki-filled ki-users">
                  </i>
                 </span>
                  ...
                  <i class="ki-filled ki-right text-xs rtl:transform rtl:rotate-180">
                   ...
                   <span class="kt-menu-icon">
                    ...
                    Group Settings
                                                ...
                                                <div class="kt-menu-item">
                                                    <a class="kt-menu-link" href="account/security/privacy-settings.html">
                 <span class="kt-menu-icon">
                    ...
                    <div class="kt-scrollable-y-auto grow" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="230px">
                        <div class="flex flex-col gap-5 py-5">
                            <div class="flex items-end gap-3.5 px-5">
                                <img alt="" class="rounded-full size-9" src="{{asset('admin/assets/media/avatars/300-5.png')}}"/>
                                <div class="flex flex-col gap-1.5">
              ...
              14:08
                                ...
                                <div class="relative shrink-0">
                                    <div class="kt-avatar size-9">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="{{asset('admin/assets/media/avatars/300-2.png')}}">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                            ...
                            <div class="flex items-end gap-3.5 px-5">
                                <img alt="" class="rounded-full size-9" src="{{asset('admin/assets/media/avatars/300-4.png')}}"/>
                                <div class="flex flex-col gap-1.5">
                                    <div class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
             ...
             14:26
                            ...
                            <div class="flex items-end gap-3.5 px-5">
                                <img alt="" class="rounded-full size-9" src="{{asset('admin/assets/media/avatars/300-1.png')}}"/>
                                <div class="flex flex-col gap-1.5">
                                    <div class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
             ...
             Design Team
                        ...
                        <div class="relative grow mx-5">
                            <img alt="" class="rounded-full size-[30px] absolute start-0 top-2/4 -translate-y-2/4 ms-2.5" src="{{asset('admin/assets/media/avatars/300-2.png')}}">
           ...
           Enabled
                            ...
                            <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                <div class="flex items-center flex-wrap gap-2">
                                    <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                        <img alt="" class="size-6" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/jira.svg">
                                        </img>
                                    </div>
                                    <div class="flex flex-col">
                                        <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              ...
              Project management
                            ...
                            <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                <div class="flex items-center flex-wrap gap-2">
                                    <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                        <img alt="" class="size-6" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/inferno.svg">
                                        </img>
                                    </div>
                                    <div class="flex flex-col">
                                        <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              ...
              Ensures healthcare app
                            ...
                            <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                <div class="flex items-center flex-wrap gap-2">
                                    <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                        <img alt="" class="size-6" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/evernote.svg"/>
                                    </div>
                                    <div class="flex flex-col">
                                        <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                                            Evernote
              ...
              Notes management app
                            ...
                            <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                <div class="flex items-center flex-wrap gap-2">
                                    <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                        <img alt="" class="size-6" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/gitlab.svg"/>
                                    </div>
                                    <div class="flex flex-col">
                                        <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                                            Gitlab
              ...
              DevOps platform
                            ...
                            <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                <div class="flex items-center flex-wrap gap-2">
                                    <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                        <img alt="" class="size-6" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/google-webdev.svg"/>
                                    </div>
                                    <div class="flex flex-col">
                                        <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                                            Google webdev
              ...
              Building web expierences
                ...
                <div class="shrink-0" data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
                    <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
                        <img alt="" class="size-9 rounded-full border-2 border-green-500 shrink-0" src="{{asset('admin/assets/media/avatars/300-2.png')}}"/>
                    </div>
                    <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
                        <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
                            <div class="flex items-center gap-2">
                                <img alt="" class="size-9 shrink-0 rounded-full border-2 border-green-500" src="{{asset('admin/assets/media/avatars/300-2.png')}}"/>
                                <div class="flex flex-col gap-1.5">
            <span class="text-sm text-foreground font-semibold leading-none">
             Cody Fisher
            </span>
                                    <a class="text-xs text-secondary-foreground hover:text-primary font-medium leading-none" href="account/home/get-started.html">
                                        c.fisher@gmail.com
                                    </a>
                                </div>
                            </div>
           ...
           Pro
             ...
             <i class="ki-filled ki-right text-xs">
                                ...
                                <div class="kt-dropdown-menu w-[220px]" data-kt-dropdown-menu="true">
                                    <ul class="kt-dropdown-menu-sub">
                                        <li>
                                            <a class="kt-dropdown-menu-link" href="account/home/get-started.html">
                                                <i class="ki-filled ki-coffee">
                                                </i>
                                                Get Started
                                            </a>
            ...
            <span class="flex items-center gap-2">
             ...
             English
             <img alt="" class="inline-block size-3.5 rounded-full" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/flags/united-states.svg"/>
            </span>
                                </button>
               ...
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block size-4 rounded-full" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/flags/united-states.svg"/>
                <span class="kt-menu-title">
                 English
                </span>
               </span>
               ...
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block size-4 rounded-full" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/flags/saudi-arabia.svg"/>
                <span class="kt-menu-title">
                 Arabic(Saudi)
                </span>
               </span>
                                        ...
                                        <li class="">
                                            <a class="kt-dropdown-menu-link" href="indexe3ae.html?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block size-4 rounded-full" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/flags/spain.svg"/>
                <span class="kt-menu-title">
                 Spanish
                </span>
               </span>
                                        ...
                                        <li class="">
                                            <a class="kt-dropdown-menu-link" href="indexe3ae.html?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block size-4 rounded-full" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/flags/germany.svg"/>
                <span class="kt-menu-title">
                 German
                </span>
               </span>
                                        ...
                                        <li class="">
                                            <a class="kt-dropdown-menu-link" href="indexe3ae.html?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block size-4 rounded-full" src="https://keenthemes.com/metronic/tailwind/dist/assets/media/flags/japan.svg"/>
                <span class="kt-menu-title">
                 Japanese
                </span>
               </span>
           ...
           <span class="flex items-center gap-2">
            ...
            <span class="font-medium text-2sm">
             Dark Mode
                            ...
                            <a class="kt-btn kt-btn-outline justify-center w-full" href="authentication/classic/sign-in.html">
                                Log out
                            </a>
                        </div>
                    </div>
