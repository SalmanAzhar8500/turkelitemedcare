...
class PatientStory extends Model
{
    ...
    protected $fillable = ['name', 'slug', 'summary', 'content', 'bullet_points', 'image_path', 'translations', 'sort_order', 'is_active', 'seo_title', 'seo_description', 'seo_keywords', 'seo_robots'];
    protected $casts = ['is_active' => 'boolean', 'translations' => 'array', 'bullet_points' => 'array'];
