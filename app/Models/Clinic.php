...
class Clinic extends Model
{
    ...
    protected $fillable = ['name', 'slug', 'location', 'website', 'email', 'phone', 'summary', 'description', 'image_path', 'translations', 'sort_order', 'is_active', 'seo_title', 'seo_description', 'seo_keywords', 'seo_robots'];
