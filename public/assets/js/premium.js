(function(){
  ...
  // Back to top
  const back=document.createElement('button');back.className='back-to-top';back.type='button';back.setAttribute('aria-label',(window.SITE_RUNTIME_COPY&&window.SITE_RUNTIME_COPY.backToTop)||'Back to top');back.innerHTML='↑';document.body.appendChild(back);
